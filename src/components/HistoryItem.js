...
const HistoryItem = ({ game, player }) => {
  ...
  if (player) {
    playerWon = "game-draw";
    if (game.winner !== "draw") {
      if ((game.winner === "playerA" && game.playerA.name === player) || (game.winner === "playerB" && game.playerB.name === player)) {
    ...
    <div className={"history-item " + playerWon}>
      <div className="players-container">
        <div className="player-container">
          <p><a href={`/player/${game.playerA.name}`}>{game.playerA.name}</a></p>
        ...
        <p className="vs">VS</p>
        <div className="player-container">
          <p><a href={`/player/${game.playerB.name}`}>{game.playerB.name}</a></p>
